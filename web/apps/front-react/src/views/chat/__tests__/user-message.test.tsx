...
describe("UserMessage rendering", () => {
  ...
  it("renders an OpenClaw skill tag when only skill_name is available", () => {
    const message = {
      id: "agent:main:dashboard:test:user:skill",
      role: "assistant",
      question: "测试技能效果",
      answer: "",
      skill: {
    ...
    expect(screen.getByText("openclaw_pdf_probe")).toBeInTheDocument();
    expect(screen.getByText("测试技能效果")).toBeInTheDocument();
  });
