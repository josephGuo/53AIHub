...
const (
	...
	SESSION_REQUEST_SOURCE      = "SESSION_REQUEST_SOURCE"
	SESSION_AGENT_API_KEY_ID    = "SESSION_AGENT_API_KEY_ID"
	SESSION_AGENT_RUN_ID        = "SESSION_AGENT_RUN_ID"
	SESSION_USER_CHANNEL        = "SESSION_USER_CHANNEL"
)
